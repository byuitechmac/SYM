...
buildingsListRaw="AG Engineering
Austin
Auxilary Services
BYU-Idaho Center
Benson
...
Philanthropies
Physical Plant Grounds Construction and Sign Shop
Physical Plant Office
Physical Plant Shop
Plumbing and Welding Shop
Radio and Graphic Services
Ricks
Rigby
Romney
...
Vehicle Operations Service Station"
...
departmentListRaw="AVProductions
...
Transcripts
Transfer Evaluation
Travel Management Services Office
Tutoring Center
University Operations
University Press
...
if [ "$promptForComputerName" == "true" ]; then compNameJSON='{ "title" : "Computer Name","required" : true,"prompt" : "Computer Name" },'; fi
...
function policyJSONConfiguration() {
    ...
    updateScriptLog "WELCOME DIALOG: PolicyJSON Configuration: Test_Two"
            ...
            "steps": [
                {
                    "listitem": "Grammarly",
                    "icon": "",
                    "progresstext": "Processing policy: Grammarly",
                    "trigger_list": [
                        {
                            "trigger": "install-Grammarly",
                            "validation": "None"
                        }
                    ]
                }
    ...
    "Test_Two" )
        policyJSON='
        {
            "steps": [
                {
                    "listitem": "VLC",
                    "icon": "https://use1.ics.services.jamfcloud.com/icon/hash_0b2775a4b829a6fe586597390eaa1b4137fc2f013e3661df79a61eec9a922003",
                    "progresstext": "VLC is a free and open source cross-platform multimedia player and framework that plays most multimedia files as well as DVDs, Audio CDs, VCDs, and various streaming protocols.",
                    "trigger_list": [
                        {
                            "trigger": "install-vlc",
                            "validation": "Remote"
            ...
            policyJSON='
            {
                "steps": [

                    {
                        ...
                        "icon": "https://use1.ics.services.jamfcloud.com/icon/hash_baad0b1a9d2e82224165ef827660f40b0c7467d5bb41b34a0b936b18efa6184e",
                        "progresstext": "Manually trigger an inventory update. When you update inventory in Jamf, it means that youre triggering the devices to send their current information and status back to the Jamf server. This information can include details like hardware specifications, software installed, security settings, compliance status, and more. This process helps administrators keep track of the devices in their fleet, understand their current state, and enforce management policies. Computers automatically update inventory once a day.",
                        "trigger_list": [
                                         {
                                            "trigger": "Invent",
                                            "validation": "None"
                    ...
                    },
                    {
                        "listitem": "Unarchiver",
                        "icon": "",
                        "progresstext": "Processing policy: Unarchiver",
                        "trigger_list": [
                                         {
                    ...
                    {
                        "listitem": "Java Runtime 2023",
                        "icon": "",
                        "progresstext": "Processing policy: Java Runtime 2023",
                        "trigger_list": [
                                         {
                    ...
                    {
                        "listitem": "Adobe Camera Raw 2023",
                        "icon": "",
                        "progresstext": "Processing policy: Adobe Camera Raw 2023",
                        "trigger_list": [
                                         {
                    ...
                    {
                        "listitem": "Drop Lab/Classroom Desktop Background",
                        "icon": "",
                        "progresstext": "Processing policy: Drop Lab/Classroom Desktop Background",
                        "trigger_list": [
                                         {
                                            "trigger": "drop-bg",
                                            "validation": "None"
                    ...
                    {
                        "listitem": "iComm Fonts",
                        "icon": "",
                        "progresstext": "Processing policy: iComm Fonts",
                        "trigger_list": [
                                         {
                    ...
                    {
                        "listitem": "5. Basic Dock - 2023",
                        "icon": "https://use1.ics.services.jamfcloud.com/icon/hash_a365b5a186859e02e8f28cefc53541ea9311ed3a239c5882e21a17e0ac38eb2c",
                        "progresstext": "Before installing, you must download Adobe Acrobat DC, Pages, Keynote, and Google Chrome from Self Service. If not, the dock will not work correctly.",
                        "trigger_list": [
                                         {
                    ...
                    {
                        "listitem": "Enable Right Click",
                        "icon": "https://use1.ics.services.jamfcloud.com/icon/hash_65325a43649efe30615a775aca06d87508161b05b16e3d45a156512182892e11",
                        "progresstext": "Processing policy: Enable Right Click",
                        "trigger_list": [
                                         {
                                            "trigger": "r_click",
                                            "validation": "None"
                    ...
                    {
                        "listitem": "Disable Microsoft Autoupdate Popup",
                        "icon": "",
                        "progresstext": "Processing policy: Disable Microsoft Autoupdate Popup",
                        "trigger_list": [
                                         {
