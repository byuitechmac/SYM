...
emailEnding="@byui.edu"

# A sorted, unique, JSON-compatible list of positions
positionList=$( echo "${positionListRaw}" | tr ',' '\n' | sort -f | uniq | sed -e 's/^/\"/' -e 's/$/\",/' -e '$ s/.$//' )

# [SYM-Helper] Branding overrides
brandingBanner="https://raw.githubusercontent.com/Chloeves/Branding-Banner/main/Screenshot%202023-10-24%20at%208.50.09%20AM.png" # [Image by benzoix on Freepik](https://www.freepik.com/author/benzoix)
...
supportTeamName="Tier 3 Imaging"
supportTeamPhone="+1 (208)496-7107"
supportTeamEmail="lab4@byui.edu"
